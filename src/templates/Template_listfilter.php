<?php http_response_code(404); die(1); // it is a template, it is protected to be called directly ?>
    ...
    public function __name__Action__verb__($id = null, $idparent = null, $event = null): void
    {
        ...
        try {
            ...
            $result = __class____classpostfix__::useCache(__cache__)->where('__argument1__=?',[$id])->toList();
            // examples:
            // $result = __class____classpostfix__::useCache(__cache__)->where('__argument1__=:__argument1__',['__argument1__'=>$id])->toList();
