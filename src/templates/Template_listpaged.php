<?php http_response_code(404); die(1); // it is a template, it is protected to be called directly ?>
    ...
    public function __name__Action__verb__($id = null, $idparent = null, $event = null): void
    {
        ...
        try {
            ...
            [$page,$pagesize,$order,$orderdir]=$this->api->getPage(__class____classpostfix__::PK[0],__class____classpostfix__::getDefName());
            if($this->api->validationOne->hasError()) {
                throw new RuntimeException(implode("\n",$this->api->validationOne->getMessages()));
            }
            $result = __class____classpostfix__::useCache(__cache__)->page($page,$pagesize)->recursive([__argument1__])->order($order.' '.$orderdir)->toList();
