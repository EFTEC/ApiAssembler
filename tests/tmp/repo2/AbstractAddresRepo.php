...
abstract class AbstractAddresRepo extends BaseSakila
{
    ...
    */
    public static function convertOutputVal(&$row)
    {
		...
		!isset($row['last_update']) and $row['last_update']=null; // timestamp
        		isset($row['_city_id'])
            and $row['_city_id']['city_id']=&$row['city_id']; // linked MANYTOONE
    ...
    */
    public static function factory($values = null, $recursivePrefix = '') {
		...
		'district'=>'',
		'city_id'=>0,
		'_city_id'=>(in_array($recursivePrefix.'_city_id',$recursive,true)) 
		                            ? CityRepo::factory(null,$recursivePrefix.'_city_id') 
		                            : null, /* MANYTOONE!! */
		'postal_code'=>'',
		'phone'=>'',
		'last_update'=>''
