...
* </pre>
*/
abstract class AbstractStaffRepo extends BaseSakila
{
    ...
    */
    public static function convertOutputVal(&$row)
    {
		...
		!isset($row['picture']) and $row['picture']=null; // blob
    ...
    */
    public static function factory($values = null, $recursivePrefix = '') {
		...
		'_rental'=>(in_array($recursivePrefix.'_rental',$recursive,true))
		                            ? [] 
		                            : null, /* ONETOMANY! */
		'_store'=>(in_array($recursivePrefix.'_store',$recursive,true))
		                            ? [] 
		                            : null, /* ONETOMANY! */
		'_tabletest'=>(in_array($recursivePrefix.'_tabletest',$recursive,true))
		                            ? [] 
		                            : null, /* ONETOMANY! */
		'first_name'=>'',
		'last_name'=>'',
    ...
    */
    public static function factoryNull($values=null) {
		...
		'_store'=>null, /* ONETOMANY! */
		'_tabletest'=>null, /* ONETOMANY! */
		'first_name'=>null,
		'last_name'=>null,
		'address_id'=>null,
