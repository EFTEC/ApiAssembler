...
/**
* Class AbstractMysecTableRepo. Copyright (c) Jorge Castro C. (https://github.com/EFTEC/PdoOne)<br>
...
abstract class AbstractMysecTableRepo extends BaseSakila
{
    ...
    public static function convertOutputVal(&$row)
    {
        if ($row === false || $row === null) {
            return;
        		...
        		!isset($row['id']) and $row['id']=null; // bigint
		!isset($row['stub']) and $row['stub']=null; // char
    ...
    */
    ...
    {
        return static::newQuery()->where($sql, $param,false,MysecTableRepo::TABLE);
    }
    ...
    */
    public static function setRecursive($recursive=[])
    {
        if(is_string($recursive)) {
            $recursive=MysecTableRepo::getRelations($recursive);
        }
