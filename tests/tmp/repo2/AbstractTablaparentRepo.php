...
/**
* Class AbstractTablaparentRepo. Copyright (c) Jorge Castro C. (https://github.com/EFTEC/PdoOne)<br>
...
* <pre>
* $code=$pdoOne->generateCodeClass('tablaparent','eftec\tests\tmp\repo2',array(),array('actor'=>'ActorRepo','actor2'=>'Actor2Repo','address'=>'AddresRepo','category'=>'CategoryRepo','city'=>'CityRepo','country'=>'CountryRepo','customer'=>'CustomerRepo','dummyt'=>'DummytRepo','dummytable'=>'DummytableRepo','film'=>'FilmRepo','film2'=>'Film2Repo','film_actor'=>'FilmActorRepo','film_category'=>'FilmCategoryRepo','film_text'=>'FilmTextRepo','fum_jobs'=>'FumJobRepo','fum_logs'=>'FumLogRepo','inventory'=>'InventoryRepo','language'=>'LanguageRepo','mysec_table'=>'MysecTableRepo','payment'=>'PaymentRepo','product'=>'ProductRepo','producttype'=>'ProducttypeRepo','producttype_auto'=>'ProducttypeAutoRepo','rental'=>'RentalRepo','staff'=>'StaffRepo','store'=>'StoreRepo','tablachild'=>'TablachildRepo','tablagrandchild'=>'TablagrandchildRepo','tablaparent'=>'TablaparentRepo','tabletest'=>'TabletestRepo','test_products'=>'TestProductRepo','typetable'=>'TypetableRepo',),array(),'','','BaseSakila','',array(),array());
* </pre>
*/
abstract class AbstractTablaparentRepo extends BaseSakila
{
    public const TABLE = 'tablaparent';
    public const IDENTITY = 'idtablaparent';
    public const PK = [
	    'idtablaparent'
	];
    ...
    public static function convertOutputVal(&$row)
    {
        if ($row === false || $row === null) {
            return;
        		...
        		!isset($row['idtablaparent']) and $row['idtablaparent']=null; // int
		!isset($row['field1']) and $row['field1']=null; // varchar
		!isset($row['idchild']) and $row['idchild']=null; // int
		!isset($row['idchild2']) and $row['idchild2']=null; // int
        		isset($row['_idchild'])
            and $row['_idchild']['idtablachild']=&$row['idchild']; // linked MANYTOONE
		isset($row['_idchild2'])
            and $row['_idchild2']['idtablachild']=&$row['idchild2']; // linked MANYTOONE
    ...
    */
    ...
    {
        return static::newQuery()->where($sql, $param,false,TablaparentRepo::TABLE);
    }
    ...
    */
    public static function setRecursive($recursive=[])
    {
        if(is_string($recursive)) {
            $recursive=TablaparentRepo::getRelations($recursive);
        }
    ...
    */
    public static function factory($values = null, $recursivePrefix = '') {
		...
		'field1'=>'',
		'idchild'=>0,
		'_idchild'=>(in_array($recursivePrefix.'_idchild',$recursive,true)) 
		                            ? TablachildRepo::factory(null,$recursivePrefix.'_idchild') 
		                            : null, /* MANYTOONE!! */
		'idchild2'=>0,
		'_idchild2'=>(in_array($recursivePrefix.'_idchild2',$recursive,true)) 
		                            ? TablachildRepo::factory(null,$recursivePrefix.'_idchild2') 
		                            : null, /* MANYTOONE!! */
		];
        		isset($row['_idchild'])
            and $row['_idchild']['idtablachild']=&$row['idchild']; // linked MANYTOONE
    ...
    */
    public static function factoryNull($values=null) {
		...
		'field1'=>null,
		'idchild'=>null,
		'_idchild'=>null, /* MANYTOONE!! */
		'idchild2'=>null,
		'_idchild2'=>null, /* MANYTOONE!! */
		];
        if ($values !== null) {
            $row = array_merge($row, $values);
        }
