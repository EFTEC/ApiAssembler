...
/**
* Class AbstractTablagrandchildRepo. Copyright (c) Jorge Castro C. (https://github.com/EFTEC/PdoOne)<br>
...
* <pre>
* $code=$pdoOne->generateCodeClass('tablagrandchild','eftec\tests\tmp\repo2',array(),array('actor'=>'ActorRepo','actor2'=>'Actor2Repo','address'=>'AddresRepo','category'=>'CategoryRepo','city'=>'CityRepo','country'=>'CountryRepo','customer'=>'CustomerRepo','dummyt'=>'DummytRepo','dummytable'=>'DummytableRepo','film'=>'FilmRepo','film2'=>'Film2Repo','film_actor'=>'FilmActorRepo','film_category'=>'FilmCategoryRepo','film_text'=>'FilmTextRepo','fum_jobs'=>'FumJobRepo','fum_logs'=>'FumLogRepo','inventory'=>'InventoryRepo','language'=>'LanguageRepo','mysec_table'=>'MysecTableRepo','payment'=>'PaymentRepo','product'=>'ProductRepo','producttype'=>'ProducttypeRepo','producttype_auto'=>'ProducttypeAutoRepo','rental'=>'RentalRepo','staff'=>'StaffRepo','store'=>'StoreRepo','tablachild'=>'TablachildRepo','tablagrandchild'=>'TablagrandchildRepo','tablaparent'=>'TablaparentRepo','tabletest'=>'TabletestRepo','test_products'=>'TestProductRepo','typetable'=>'TypetableRepo',),array(),'','','BaseSakila','',array(),array());
* </pre>
*/
abstract class AbstractTablagrandchildRepo extends BaseSakila
{
    public const TABLE = 'tablagrandchild';
    public const IDENTITY = 'idgrandchild';
    public const PK = [
	    'idgrandchild'
	];
    ...
    public static function convertOutputVal(&$row)
    {
        if ($row === false || $row === null) {
            return;
        		...
        		!isset($row['idgrandchild']) and $row['idgrandchild']=null; // int
		!isset($row['NameGrandChild']) and $row['NameGrandChild']=null; // varbinary
    ...
    */
    ...
    {
        return static::newQuery()->where($sql, $param,false,TablagrandchildRepo::TABLE);
    }
    ...
    */
    public static function setRecursive($recursive=[])
    {
        if(is_string($recursive)) {
            $recursive=TablagrandchildRepo::getRelations($recursive);
        }
    ...
    */
    public static function factory($values = null, $recursivePrefix = '') {
        ...
        $row= [
		'idgrandchild'=>0,
		'_tablachild'=>(in_array($recursivePrefix.'_tablachild',$recursive,true))
		                            ? [] 
		                            : null, /* ONETOMANY! */
		'NameGrandChild'=>''
		];
