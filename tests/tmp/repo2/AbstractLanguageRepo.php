...
/**
* Class AbstractLanguageRepo. Copyright (c) Jorge Castro C. (https://github.com/EFTEC/PdoOne)<br>
...
abstract class AbstractLanguageRepo extends BaseSakila
{
    ...
    */
    public static function convertOutputVal(&$row)
    {
		...
		!isset($row['name']) and $row['name']=null; // char
    ...
    */
    ...
    {
        return static::newQuery()->where($sql, $param,false,LanguageRepo::TABLE);
    }
    ...
    */
    public static function setRecursive($recursive=[])
    {
        if(is_string($recursive)) {
            $recursive=LanguageRepo::getRelations($recursive);
        }
    ...
    */
    public static function factory($values = null, $recursivePrefix = '') {
        ...
        $row= [
		'language_id'=>0,
		'_film'=>(in_array($recursivePrefix.'_film',$recursive,true))
		                            ? [] 
		                            : null, /* ONETOMANY! */
		'_film2'=>(in_array($recursivePrefix.'_film2',$recursive,true))
		                            ? [] 
		                            : null, /* ONETOMANY! */
		'name'=>'',
		'last_update'=>''
    ...
    */
    public static function factoryNull($values=null) {
        $row= [
		'language_id'=>null,
		'_film'=>null, /* ONETOMANY! */
		'_film2'=>null, /* ONETOMANY! */
		'name'=>null,
		'last_update'=>null
		];
        if ($values !== null) {
