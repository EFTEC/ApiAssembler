...
/**
* Class AbstractInventoryRepo. Copyright (c) Jorge Castro C. (https://github.com/EFTEC/PdoOne)<br>
...
* <pre>
* $code=$pdoOne->generateCodeClass('inventory','eftec\tests\tmp\repo2',array(),array('actor'=>'ActorRepo','actor2'=>'Actor2Repo','address'=>'AddresRepo','category'=>'CategoryRepo','city'=>'CityRepo','country'=>'CountryRepo','customer'=>'CustomerRepo','dummyt'=>'DummytRepo','dummytable'=>'DummytableRepo','film'=>'FilmRepo','film2'=>'Film2Repo','film_actor'=>'FilmActorRepo','film_category'=>'FilmCategoryRepo','film_text'=>'FilmTextRepo','fum_jobs'=>'FumJobRepo','fum_logs'=>'FumLogRepo','inventory'=>'InventoryRepo','language'=>'LanguageRepo','mysec_table'=>'MysecTableRepo','payment'=>'PaymentRepo','product'=>'ProductRepo','producttype'=>'ProducttypeRepo','producttype_auto'=>'ProducttypeAutoRepo','rental'=>'RentalRepo','staff'=>'StaffRepo','store'=>'StoreRepo','tablachild'=>'TablachildRepo','tablagrandchild'=>'TablagrandchildRepo','tablaparent'=>'TablaparentRepo','tabletest'=>'TabletestRepo','test_products'=>'TestProductRepo','typetable'=>'TypetableRepo',),array(),'','','BaseSakila','',array(),array());
* </pre>
*/
abstract class AbstractInventoryRepo extends BaseSakila
{
    public const TABLE = 'inventory';
    public const IDENTITY = 'inventory_id';
    public const PK = [
	    'inventory_id'
	];
    ...
    public static function getDef($column = null, $filter = null): array
    {
        $r = [
		    'inventory_id' => [
		        ...
		        'null' => FALSE,
		        'identity' => TRUE,
		        'sql' => 'mediumint unsigned not null auto_increment'
		    ],
		    'film_id' => [
		        'phptype' => 'int',
		        'conversion' => NULL,
    ...
    */
    ...
    {
        return static::newQuery()->where($sql, $param,false,InventoryRepo::TABLE);
    }
    ...
    */
    public static function setRecursive($recursive=[])
    {
        if(is_string($recursive)) {
            $recursive=InventoryRepo::getRelations($recursive);
        }
