...
abstract class AbstractRentalRepo extends BaseSakila
{
    ...
    public static function getDef($column = null, $filter = null): array
    {
        $r = [
		    ...
		    'inventory_id' => [
		        ...
		        'null' => FALSE,
		        'identity' => FALSE,
		        'sql' => 'mediumint unsigned not null'
		    ],
		    'customer_id' => [
		        'phptype' => 'int',
		        'conversion' => NULL,
    ...
    */
    public static function convertOutputVal(&$row)
    {
		...
		!isset($row['inventory_id']) and $row['inventory_id']=null; // mediumint
		...
		isset($row['_inventory_id'])
            and $row['_inventory_id']['inventory_id']=&$row['inventory_id']; // linked MANYTOONE
		isset($row['_staff_id'])
    ...
    public static function getDefFK($structure=false) {
        if ($structure) {
            return [
			    ...
			    'inventory_id' => 'FOREIGN KEY REFERENCES`inventory`(`inventory_id`) ON UPDATE CASCADE ON DELETE CASCADE',
    ...
    */
    public static function factory($values = null, $recursivePrefix = '') {
		...
		'rental_date'=>'',
		'inventory_id'=>0,
		'_inventory_id'=>(in_array($recursivePrefix.'_inventory_id',$recursive,true)) 
		                            ? InventoryRepo::factory(null,$recursivePrefix.'_inventory_id') 
		                            : null, /* MANYTOONE!! */
		'customer_id'=>0,
