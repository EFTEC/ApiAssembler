...
/**
* Class AbstractFilm2Repo. Copyright (c) Jorge Castro C. (https://github.com/EFTEC/PdoOne)<br>
...
abstract class AbstractFilm2Repo extends BaseSakila
{
    ...
    */
    ...
    {
        return static::newQuery()->where($sql, $param,false,Film2Repo::TABLE);
    }
    ...
    public static function getDefFK($structure=false) {
        ...
        return [
		    ...
		    'original_language_id' => [
		        ...
		        'reftable' => 'language',
		        'extra' => ' ON UPDATE CASCADE',
		        'name' => 'fk_film2_original_language_id'
		    ],
    ...
    */
    public static function setRecursive($recursive=[])
    {
        if(is_string($recursive)) {
            $recursive=Film2Repo::getRelations($recursive);
        }
