...
/**
* Class AbstractActor2Repo. Copyright (c) Jorge Castro C. (https://github.com/EFTEC/PdoOne)<br>
...
abstract class AbstractActor2Repo extends BaseSakila
{
    ...
    public static function getDef($column = null, $filter = null): array
    {
        $r = [
		    ...
		    'first_name' => [
		        ...
		        'null' => FALSE,
		        'identity' => FALSE,
		        'sql' => 'varchar(45) not null default \'ABC\''
		    ],
		    'last_name' => [
		        'phptype' => 'string',
		        'conversion' => NULL,
    ...
    */
    ...
    {
        return static::newQuery()->where($sql, $param,false,Actor2Repo::TABLE);
    }
    ...
    */
    public static function setRecursive($recursive=[])
    {
        if(is_string($recursive)) {
            $recursive=Actor2Repo::getRelations($recursive);
        }
