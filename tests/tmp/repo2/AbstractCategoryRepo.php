...
/**
* Class AbstractCategoryRepo. Copyright (c) Jorge Castro C. (https://github.com/EFTEC/PdoOne)<br>
...
abstract class AbstractCategoryRepo extends BaseSakila
{
    ...
    */
    ...
    {
        return static::newQuery()->where($sql, $param,false,CategoryRepo::TABLE);
    }
    ...
    */
    public static function setRecursive($recursive=[])
    {
        if(is_string($recursive)) {
            $recursive=CategoryRepo::getRelations($recursive);
        }
