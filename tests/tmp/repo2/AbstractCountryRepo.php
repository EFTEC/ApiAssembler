...
abstract class AbstractCountryRepo extends BaseSakila
{
    ...
    */
    public static function factory($values = null, $recursivePrefix = '') {
        ...
        $row= [
		'country_id'=>0,
		'_city'=>(in_array($recursivePrefix.'_city',$recursive,true))
		                            ? [] 
		                            : null, /* ONETOMANY! */
		'country'=>'',
		'last_update'=>''
