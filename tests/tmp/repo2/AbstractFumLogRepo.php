...
/**
* Class AbstractFumLogRepo. Copyright (c) Jorge Castro C. (https://github.com/EFTEC/PdoOne)<br>
...
abstract class AbstractFumLogRepo extends BaseSakila
{
    ...
    public static function convertOutputVal(&$row)
    {
        if ($row === false || $row === null) {
            return;
        		...
        		!isset($row['idjoblog']) and $row['idjoblog']=null; // int
		!isset($row['idjob']) and $row['idjob']=null; // int
		!isset($row['idrel']) and $row['idrel']=null; // varchar
		!isset($row['type']) and $row['type']=null; // varchar
		!isset($row['description']) and $row['description']=null; // varchar
		!isset($row['date']) and $row['date']=null; // timestamp
    ...
    */
    ...
    {
        return static::newQuery()->where($sql, $param,false,FumLogRepo::TABLE);
    }
    ...
    */
    public static function setRecursive($recursive=[])
    {
        if(is_string($recursive)) {
            $recursive=FumLogRepo::getRelations($recursive);
        }
