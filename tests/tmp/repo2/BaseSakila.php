...
/**
 * Class BaseSakila. Copyright (c) Jorge Castro C. (https://github.com/EFTEC/PdoOne)<br>
 * Generated by PdoOne Version 2.27 Date generated Mon, 07 Mar 2022 08:48:21 -0400.
 */
class BaseSakila extends _BasePdoOneRepo
{
    const type = 'mysql';
    const COMPILEDVERSION=8;
    const NS = 'eftec\tests\tmp\repo2\\';
