...
/**
* Class AbstractProducttypeRepo. Copyright (c) Jorge Castro C. (https://github.com/EFTEC/PdoOne)<br>
...
abstract class AbstractProducttypeRepo extends BaseSakila
{
    ...
    */
    ...
    {
        return static::newQuery()->where($sql, $param,false,ProducttypeRepo::TABLE);
    }
    ...
    */
    public static function setRecursive($recursive=[])
    {
        if(is_string($recursive)) {
            $recursive=ProducttypeRepo::getRelations($recursive);
        }
