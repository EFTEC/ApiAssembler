...
/**
* Class AbstractTypetableRepo. Copyright (c) Jorge Castro C. (https://github.com/EFTEC/PdoOne)<br>
...
abstract class AbstractTypetableRepo extends BaseSakila
{
    ...
    */
    ...
    {
        return static::newQuery()->where($sql, $param,false,TypetableRepo::TABLE);
    }
    ...
    */
    public static function setRecursive($recursive=[])
    {
        if(is_string($recursive)) {
            $recursive=TypetableRepo::getRelations($recursive);
        }
