...
* Class AbstractProductCategoryRepo
* <pre>
 * $code=$pdoOne->generateCodeClass('productcategories','examples\newexample\repo',array(),array('productcategories'=>'ProductCategoryRepo','products'=>'ProductRepo','users'=>'UserRepo',),array(),'','','BaseApiassembler','',array(),array());
 * </pre>
*/
abstract class AbstractProductCategoryRepo extends BaseApiassembler
{
    const TABLE = 'productcategories';
    const IDENTITY = 'IdProductCategory';
    const PK = [
	    'IdProductCategory'
	];
    const ME=__CLASS__;
    ...
    */
    ...
    {
        return static::newQuery()->where($sql, $param,false,ProductCategoryRepo::TABLE);
    }
    ...
    public static function getDefFK($structure=false) {
        ...
        return [
		    '_products' => [
		        'key' => 'ONETOMANY',
		        'col' => 'IdProductCategory',
		        'reftable' => 'products',
		        'refcol' => '_IdProductCategory'
		    ]
		];
    }
    ...
    */
    public static function setRecursive($recursive=[])
    {
        if(is_string($recursive)) {
            $recursive=ProductCategoryRepo::getRelations($recursive);
        }
    ...
    */
    public static function factory($values = null, $recursivePrefix = '') {
        ...
        $row= [
		'IdProductCategory'=>0,
		'_products'=>(in_array($recursivePrefix.'_products',$recursive,true))
		                            ? [] 
		                            : null, /* ONETOMANY! */
		'Name'=>''
		];
