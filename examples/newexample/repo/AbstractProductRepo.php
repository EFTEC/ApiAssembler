...
/**
* Generated by PdoOne Version 2.25 Date generated Fri, 11 Feb 2022 11:34:47 -0400.123
* DO NOT EDIT THIS CODE. Use instead the Repo Class.
* @copyright (c) Jorge Castro C. MIT License  https://github.com/EFTEC/PdoOne
* Class AbstractProductRepo
* <pre>
 * $code=$pdoOne->generateCodeClass('products','examples\newexample\repo',array(),array('productcategories'=>'ProductCategoryRepo','products'=>'ProductRepo','users'=>'UserRepo',),array(),'','','BaseApiassembler','',array(),array());
 * </pre>
*/
abstract class AbstractProductRepo extends BaseApiassembler
{
    const TABLE = 'products';
    const IDENTITY = 'IdProduct';
    const PK = [
	    'IdProduct'
	];
    const ME=__CLASS__;
    ...
    */
    public static function convertOutputVal(&$row)
    {
		...
		!isset($row['IdProductCategory']) and $row['IdProductCategory']=null; // int
		!isset($row['Price']) and $row['Price']=null; // decimal
        		isset($row['_IdProductCategory'])
            and $row['_IdProductCategory']['IdProductCategory']=&$row['IdProductCategory']; // linked MANYTOONE
    ...
    */
    ...
    {
        return static::newQuery()->where($sql, $param,false,ProductRepo::TABLE);
    }

    public static function getDefFK($structure=false) {
        if ($structure) {
            return [
			    'IdProductCategory' => 'FOREIGN KEY REFERENCES`productcategories`(`IdProductCategory`)'
			];
        }
        ...
        return [
		    'IdProductCategory' => [
		        'key' => 'FOREIGN KEY',
		        'refcol' => 'IdProductCategory',
		        'reftable' => 'productcategories',
		        'extra' => '',
		        'name' => 'products_fk1'
		    ],
		    '_IdProductCategory' => [
    ...
    */
    public static function setRecursive($recursive=[])
    {
        if(is_string($recursive)) {
            $recursive=ProductRepo::getRelations($recursive);
        }
    ...
    */
    public static function factory($values = null, $recursivePrefix = '') {
		...
		'Name'=>'',
		'IdProductCategory'=>0,
		'_IdProductCategory'=>(in_array($recursivePrefix.'_IdProductCategory',$recursive,true)) 
		                            ? ProductCategoryRepo::factory(null,$recursivePrefix.'_IdProductCategory') 
		                            : null, /* MANYTOONE!! */
		'Price'=>0.0
		];
        		isset($row['_IdProductCategory'])
    ...
    */
    public static function factoryNull($values=null) {
		...
		'_IdProductCategory'=>null, /* MANYTOONE!! */
		'Price'=>null
		];
        if ($values !== null) {
            $row = array_merge($row, $values);
