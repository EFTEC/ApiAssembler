...
abstract class AbstractUserRepo extends BaseApiassembler
{
    ...
    */
    public static function convertOutputVal(&$row)
    {
		...
		!isset($row['Level']) and $row['Level']=null; // varchar
    ...
    */
    ...
    {
        return static::newQuery()->where($sql, $param,false,UserRepo::TABLE);
    }
    ...
    */
    public static function setRecursive($recursive=[])
    {
        if(is_string($recursive)) {
            $recursive=UserRepo::getRelations($recursive);
        }
